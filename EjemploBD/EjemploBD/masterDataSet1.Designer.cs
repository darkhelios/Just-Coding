...
namespace EjemploBD.masterDataSet1TableAdapters {
    ...
    public partial class EstadoTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Estado] ([estado]) VALUES (@estado);\r\nSELECT estadoid, estado " +
                "FROM Estado WHERE (estadoid = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Estado] SET [estado] = @estado WHERE (([estadoid] = @Original_estad" +
                "oid) AND ((@IsNull_estado = 1 AND [estado] IS NULL) OR ([estado] = @Original_est" +
                "ado)));\r\nSELECT estadoid, estado FROM Estado WHERE (estadoid = @estadoid)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT estadoid, estado FROM dbo.Estado";
        ...
        public virtual int Fill(masterDataSet1.EstadoDataTable dataTable) {
        ...
        public virtual masterDataSet1.EstadoDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            masterDataSet1.EstadoDataTable dataTable = new masterDataSet1.EstadoDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(masterDataSet1.EstadoDataTable dataTable) {
        ...
        public virtual int Delete(int Original_estadoid, string Original_estado) {
        ...
        public virtual int Update(string estado, int Original_estadoid, string Original_estado, int estadoid) {
            if ((estado == null)) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string estado, int Original_estadoid, string Original_estado) {
